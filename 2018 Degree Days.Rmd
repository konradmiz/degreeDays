...
It looks like June 2015 was generally hotter hotter than this year has been to date, though we've decreased the gap since July 1st (Fractional year: `r decimal_date(as_date("2018-07-01")) - 2018`). We can look at just June and August heat:
...
We've had a hotter summer if we start counting on July 1st. All of August has been hotter so far too (`r decimal_date(as_date("2018-08-01")) - 2018` - `r decimal_date(as_date("2018-08-17")) - 2018`).
